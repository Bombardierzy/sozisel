...
import { ApolloClient, ApolloLink, InMemoryCache, NormalizedCacheObject, createHttpLink, split } from '@apollo/client';
...
function createApolloSocketLink(): ApolloLink {
  const socket = createAbsintheSocket(new PhoenixSocket(`ws://${HOST}:4000/socket`));
